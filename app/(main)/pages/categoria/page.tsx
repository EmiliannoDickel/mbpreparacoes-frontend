    ...
    const Categoria = () => {
        const ObjetoNovo: Projeto.Categoria = {  
            id: null,
            nome: ''
        };

    const [objetos, setObjetos] = useState<Projeto.Categoria[]>([]);
    ...
    const [objeto, setObjeto] = useState<Projeto.Categoria>(ObjetoNovo); 
    const [selectedObjetos, setSelectedObjetos] = useState<Projeto.Categoria[]>([]);
    ...
    useEffect(() => {
        ...
        const editObjeto = (objeto: Projeto.Categoria) => { //editar
            setObjeto({ ...objeto });
            setObjetoDialog(true);
        };

        const confirmDeleteObjeto = (objeto: Projeto.Categoria) => { //confirmar remocao
            setObjeto(objeto);
        ...
        const idBodyTemplate = (rowData: Projeto.Categoria) => {
            return (
                <>
        ...
        const nomeBodyTemplate = (rowData: Projeto.Categoria) => {
            return (
                <>
        ...
        const header = (
            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                <h5 className="m-0">Gerenciamento De Categoria</h5>
            ...
            <div className="grid crud-demo">
                <div className="col-12">
                    ...
                    >
                        ...
                        <Dialog visible={objetoDialog} style={{ width: '450px' }} header="Detalhes Da Categoria" modal className="p-fluid" footer={objetoDialogFooter} onHide={hideDialog}>
                            <div className="field">
                        ...
                        <Dialog visible={deleteObjetoDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteObjetoDialogFooter} onHide={hideDeleteObjetoDialog}>
                            <div className="flex align-items-center justify-content-center">
                                ...
                                {objeto && (
                                    <span>
                                    Você Realmente deseja excluir a Categorias? <b>{objeto.nome}</b>?
                                    </span>
                                )}
                            </div>
                        </Dialog>
                        ...
                        <Dialog visible={deleteObjetosDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteObjetosDialogFooter} onHide={hideDeleteObjetosDialog}>
                            <div className="flex align-items-center justify-content-center">
                                <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                                {objeto && <span>Você Realmente deseja excluir as Categorias selecionados??</span>}
                            </div>
                        </Dialog>
                    </div>
                </div>
